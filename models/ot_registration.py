...
# 6h-8h, 18h30-22h, 22h-6h, 6h-22h
# morning, normal, night, day, saturday, sunday, weekend, holiday
CATEGORY_CODE = {'normal_day': '01010000',
                 'normal_day_morning': '01010000',
                 'normal_day_night': '00100000',
                 'saturday': '00011010',
                 'sunday': '00010110',
                 'weekend_day_night': '00100010',
                 'holiday': 'Ngày lễ',
                 'holiday_day_night': 'Ngày lễ - Ban đêm',
                 'compensatory_normal': 'Bù ngày lễ vào ngày thường',
                 'compensatory_night': 'Bù ngày lễ vào ban đêm',
    ...
    def _compute_category(self):
        ...
        for record in self:
            if record.date_from in vi_holidays or record.date_to in vi_holidays:
                category_res = 'holiday'
            elif record.date_from.weekday() == 5:
                category_res = 'saturday'
            else:
                category_res = 'unknown'
            record.category = category_res
